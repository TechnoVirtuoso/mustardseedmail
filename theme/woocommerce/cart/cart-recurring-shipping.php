...
<tr class="shipping recurring-total <?php echo esc_attr( $recurring_cart_key ); ?>">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php elseif ( ! WC()->customer->has_calculated_shipping() ) : ?>
			<?php echo wp_kses_post( wpautop( __( 'Included with subscription.', 'woocommerce-subscriptions' ) ) ); ?>
		<?php else : ?>
			<?php echo wp_kses_post( apply_filters( 'woocommerce_no_shipping_available_html', wpautop( __( 'Included with subscription.', 'woocommerce-subscriptions' ) ) ) ); ?>
		<?php endif; ?>
