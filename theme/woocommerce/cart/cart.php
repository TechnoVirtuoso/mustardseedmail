...
<div class="cart-portion cart-page">
	<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
		...
		<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
			<div class="shop_table-wrapper">
				...
				foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
					...
					if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
						...
						<div
							...
							<div class="product-field product-info">
								...
								$product_quantity = woocommerce_quantity_input(
									array(
										...
										'max_value' => 1,// for increase use $max_quantity instead of 1
							...
							<!-- <div class="product-field product-subtotal" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
								<?php
				...
				<?php
				if (false) {
					echo '<input type="submit" class="button" name="update_cart" value="' . esc_attr__('Update Cart', 'woocommerce') . '" />';
				}
				?>
					...
					<td colspan="6" class="actions">
						<?php if (wc_coupons_enabled()) { ?>
							<div class="coupon">
								...
								</label> <input type="text" name="promo_code" class="input-text" id="coupon_code" value=""
									placeholder="<?php esc_attr_e('Promo Code', 'woocommerce'); ?>" /> <button type="submit"
